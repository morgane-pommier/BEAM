...
note that this code will change before WKBBEAM start date: it is currently not optimised and will be replaced shortly by a parallelised version. We advise participants not to run this code yet (it takes about 10 hours) but we provide it so that you can see the general approach used (that part will not changed).  
...
source("lib/reliability_estimation.R")
```
