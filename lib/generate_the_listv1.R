...
#global variables created at the start of beam.r
annex01_species <-annex01_species 
...
###### summary table for report, can we separate it by year 
...
#####fix manual intervention with automation
